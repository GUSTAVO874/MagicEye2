...
namespace MagicEye2.Web.Controllers
{
    public class AuthController : Controller
    {
        ...
        [HttpGet]
        public IActionResult Register()//este método permite mostrar la vista
        {
            //con ViewBag puedo sacar la lista de roles y pasarlos a la vista a
        ...
        //usando .net identity, este se usa más arriba en el login
